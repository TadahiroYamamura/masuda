...
Superseded by [[0059-remove-tdd-mode]] (2026-09-04)

Accepted (2026-08-09) — v0.1に達していない段階で、実際に一度も回っていない機能のために状態機械の15%と唯一の破壊的git操作を抱えることが割に合わないと判断し、TDDモードごと削除した。決定論に寄せたいという動機自体は失効していない
